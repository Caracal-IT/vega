...
const AppMenu = class {
    ...
    render() {
        return (h("div", null, h("stencil-route-link", { url: '/' }, h("i", { class: "material-icons" }, "home"), "Home"), h("stencil-route-link", { url: '/content/login' }, h("i", { class: "material-icons" }, "lock_open"), "Login"), h("stencil-route-link", { url: '/content/register' }, h("i", { class: "material-icons" }, "account_box"), "Register"), h("stencil-route-link", { url: '/content/banking' }, h("i", { class: "material-icons" }, "account_balance"), "Banking")));
    }
