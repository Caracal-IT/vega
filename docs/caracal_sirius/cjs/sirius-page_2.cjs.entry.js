...
const SiriusPage = class {
    ...
    render() {
        const renderItem = (item) => core.h(item.tag, Object.assign({ "wf-element": true, onInput: this.inputHandler.bind(this) }, item, { context: this.page["context"], value: this.modelService.getComponentModelValue(item) }));
